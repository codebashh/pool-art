...
part 'views/widgets/_latest_project_card.dart';
part 'views/widgets/_stats_card.dart';
part 'views/widgets/_top_slider.dart';
part 'views/widgets/_top_slider_mobile.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    if (projectCubit.state.data == null ||
        productCubit.state.data == null ||
        productCubit.state.data!.isEmpty ||
        projectCubit.state.data!.isEmpty) {
      projectCubit.fetch();
      productCubit.fetch();
    }
